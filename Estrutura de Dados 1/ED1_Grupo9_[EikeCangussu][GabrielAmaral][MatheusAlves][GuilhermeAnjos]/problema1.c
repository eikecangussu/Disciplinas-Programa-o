...
Funcao: validaExpTipoA

Descrição: Analisa a expressão numérica recebida e retorna se eco é valida para a estrutura do tipo A.
...
int main(){
    ...
    if(validaExpTipoA(expressao) && validaExpTipoB(expressao)){
        printf("A expressao %s e validada pelas opcoes (a) e (b).\n", expressao);
    }else if(validaExpTipoA(expressao) && !validaExpTipoB(expressao)){
        printf("A expressao %s e validade apenas pela opcao (a).\n", expressao);
    }else if(!validaExpTipoA(expressao) && validaExpTipoB(expressao)){
        printf("A expressao %s e validade apenas pela opcao (b).\n", expressao);
    }else{
        printf("A expressao %s nao e validade em nenhuma das opcoes.\n", expressao);
    }
